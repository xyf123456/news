...
<div id="header">
    <div id="top_login">
        ...
        <%--<form id="login" method="post" action="/news/doLogin.jsp">--%>
        <%--<form id="login" method="post" action="<%=basePath%>newspages/control/doLogin.jsp">--%>
        <form id="login" method="post" action="<%=basePath%>/loginAndOut?opr=login">
            <label for="username">登录名</label><input type="text" name="username" id="username" value=""
                                                    class="login_input"/>
            <label for="upwd">密&#160;&#160;码</label><input type="password" name="upwd" id="upwd" value=""
                                                           class="login_input"/>
...
<div id="container">
    ...
    <div class="main">
        ...
        <div class="content">
            ...
            <ul class="classlist">
                <li><a href='newspages/news_add.html'> 深足教练组：说我们买球是侮辱 朱广沪常暗中支招 </a><span> 2009-10-28 01:03:51.0 </span>
                </li>
